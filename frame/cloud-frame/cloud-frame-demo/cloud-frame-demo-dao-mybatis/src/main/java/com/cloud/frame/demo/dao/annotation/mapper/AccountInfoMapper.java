package com.cloud.frame.demo.dao.annotation.mapper;

import com.cloud.frame.demo.dao.annotation.entity.AccountInfo;
...
/**
 * @Mapper @MapperScan("com.cloud.frame.demo.dao.generator")
